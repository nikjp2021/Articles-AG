...
3. Generate 4 distinct image prompts tailored to each platform's tone, and create a short, descriptive ALT text for each image. Write these prompts and their corresponding ALT text into an `assets-DD-MM-YYYY.md` file in the topic folder. 
